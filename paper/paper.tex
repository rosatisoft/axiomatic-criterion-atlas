...
\setlist{nosep}
\begin{document}
\title{Axiomatic Criterion Atlas (ACA)}
\maketitle
...
This triaxial structure enables derived operational fields (e.g., \texttt{scientific\_inquiry}, \texttt{security\_training}, \texttt{phishing\_attack}) to emerge from stable geometric configurations rather than being treated as primitive categories.
...
\includegraphics[width=0.9\linewidth]{assets/figure-01.png}
\end{figure}
...
\subsection{Terminological convention.}
...
\subsection{3.1 Semantic Embedding Space}
...
\subsection{3.2 Semantic Fields}
...
\subsection{3.3 Contextual Compatibility}
...
\subsection{3.4 Limitation of Contextual Coherence}
...
\subsection{3.5 Directional Invariants}
...
\subsection{3.6 Epistemic Orientation}
...
\subsection{3.7 Semantic Trajectories}
...
\subsection{3.8 Criterion Drift}
...
\subsection{3.9 Geometric Criterion Preservation}
...
\subsection{3.10 Deterministic Runtime Criterion Policies}
...
\subsection{3.11 Triaxial Criterion Projection}
...
\subsection{3.12 Central Theoretical Claim}
...
\subsection{4.1 Embedding Space}
...
\subsection{4.3 Semantic Field Subspace}
...
\subsection{4.4 Contextual Projection}
...
\subsection{4.6 Field Selection}
...
\subsection{4.7 Contextual Coherence}
...
\subsection{4.8 Directional Invariant Poles}
...
\subsection{4.9 Epistemic Orientation Score}
...
\subsection{4.10 Aggregate Epistemic Integrity}
...
\subsection{4.11 Semantic Trajectory}
...
\subsection{4.12 Criterion Drift}
...
\subsection{4.13 Geometric Criterion Preservation}
...
\subsection{4.14 Deterministic Runtime Policy}
...
\subsection{4.15 Central Mathematical Claim}
...
The second layer extends the baseline into the v0.3 triaxial artifact methodology. In this layer, semantic inputs are projected into a discrete criterion space defined by Foundation, Context, and Principle:
...
\subsection{5.1 Experimental Objectives}
...
\subsection{5.2 Semantic Fields}
...
\subsection{5.2.1 Fundamental Field}
...
\subsection{5.2.2 Factual Field}
...
\subsection{5.2.3 Rhetorical Field}
...
\subsection{5.3 Artifact Construction Pipeline}
...
\begin{figure}[htbp]\centering
\includegraphics[width=0.9\linewidth]{assets/figure-02.png}
\end{figure}
...
\subsection{5.4 Artifact Repository Structure and Manifest}
...
\subsection{5.5 Anchor Embeddings}
...
\subsection{5.6 Context Matrix Construction}
...
\subsection{5.7 Directional Invariant Construction}
...
\subsection{5.8 Dialogue Trajectory Dataset}
...
\subsection{5.9 Runtime Evaluation Metrics}
...
\subsection{5.10 Runtime Criterion Policy}
...
\subsection{5.11 PCA Visualization}
...
\subsection{5.12 Experimental Interpretation Strategy}
...
\begin{figure}[htbp]\centering
\includegraphics[width=0.9\linewidth]{assets/figure-03.png}
\end{figure}
...
\begin{figure}[htbp]\centering
\includegraphics[width=0.9\linewidth]{assets/figure-04.png}
\end{figure}
...
\begin{figure}[htbp]\centering
\includegraphics[width=0.9\linewidth]{assets/figure-05.png}
\end{figure}
...
\begin{figure}[htbp]\centering
\includegraphics[width=0.9\linewidth]{assets/figure-06.png}
\end{figure}
...
\subsubsection{6.5.1 Triaxial Artifact Validation Results}
...
\caption{ACA v0.3 triaxial artifact validation results. The validation suite evaluates derived fields, trajectory interpretation, individual axis assignment, and diagnostic sensitivity.}
...
\begin{figure}[htbp]\centering
\includegraphics[width=0.9\linewidth]{assets/figure-07.png}
\end{figure}

\subsection{6.6 ACA Runtime}
...
\subsection{6.6.1 Runtime Operational Pipeline}
...
\begin{figure}[htbp]\centering
\includegraphics[width=0.9\linewidth]{assets/figure-08.png}
\end{figure}

\subsection{6.6.2 Experimental Significance}
...
\subsection{6.6.3 Semantic Topology Configuration}
...
\subsection{6.6.4 Semantic Field Organization}
...
\subsection{6.6.5 Neighboring Topology}
...
\subsection{6.6.6 Destabilizing Topology}
...
\subsection{6.6.7 Topology-Aware Runtime Evaluation}
...
\subsection{6.6.8 Semantic Navigation Interpretation}
...
\subsection{6.7 Adversarial Semantic Drift Results}
...
\subsubsection{Proximity vs Orientation Divergence}
...
\begin{figure}[htbp]\centering
\includegraphics[width=0.9\linewidth]{assets/figure-09.png}
\end{figure}

\subsection{6.8 Core Experimental Finding}
...
\subsection{6.9 Runtime Criterion Benchmark}
...
\subsection{6.9.1 Prompt-Heavy Criterion Strategy}
...
\subsection{6.9.2 ACA Runtime Criterion Strategy}
...
\subsection{6.9.3 Benchmark Configuration}
...
\subsection{6.9.4 Runtime Results}

The benchmark produced the following total runtime costs across the evaluated scenarios:

\begin{figure}[htbp]\centering
\includegraphics[width=0.9\linewidth]{assets/figure-10.png}
\end{figure}

\begin{figure}[htbp]\centering
\includegraphics[width=0.9\linewidth]{assets/figure-11.png}
\end{figure}
...
\subsection{6.9.5 Interpretation}
...
\begin{figure}[htbp]\centering
\includegraphics[width=0.9\linewidth]{assets/figure-12.png}
\end{figure}

\subsection{6.9.6 Runtime Criterion Persistence}
...
\subsection{6.9.7 Operational Implications}
